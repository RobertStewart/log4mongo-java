...
define 'log4mongo-java' do
  ...
  compile.with 'log4j:log4j:jar:1.2.16', 'org.mongodb:mongo-java-driver:jar:2.0'
  compile.with 'junit:junit:jar:4.7', 'log4j:log4j:jar:1.2.16', 'org.mongodb:mongo-java-driver:jar:2.0'
